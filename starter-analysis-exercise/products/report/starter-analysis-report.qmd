...
type_distribution <- cleaned_data %>%
  group_by(type) %>%
  summarise(count = n())

# Plot the distribution of content types
ggplot(type_distribution, aes(x = type, y = count, fill = type)) +
  geom_bar(stat = "identity") +
  labs(title = "Distribution of Content Types - Movies v TV Shows", x = "Type", y = "Count")
```
